...
export default function PantallaMiercoles() {
  ...
  return (
    <div>
      ...
      <div className="vista-miercoles">
        <TablaLoteria nombre="META" filas={meta} />
        <TablaLoteria nombre="VALLE" filas={valle} />
        <TablaLoteria nombre="MANIZALES" filas={manizales} />
      </div>
    </div>
  );
}