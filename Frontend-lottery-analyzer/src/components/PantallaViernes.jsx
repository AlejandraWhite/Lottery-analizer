...
export default function PantallaViernes({ busqueda, busquedaFecha, modoBusqueda = "cualquiera" }) {
  ...
  return (
    <div>
      ...
      <div className="vista-miercoles">
        <TablaLoteria nombre="RISARALDA" filas={risaralda} busqueda={busqueda} busquedaFecha={busquedaFecha} modoBusqueda={modoBusqueda} />
        <TablaLoteria nombre="MEDELLÍN" filas={medellin} busqueda={busqueda} busquedaFecha={busquedaFecha} modoBusqueda={modoBusqueda} />
        <TablaLoteria nombre="SANTANDER" filas={santander} busqueda={busqueda} busquedaFecha={busquedaFecha} modoBusqueda={modoBusqueda} />
      </div>
    </div>
  );
}